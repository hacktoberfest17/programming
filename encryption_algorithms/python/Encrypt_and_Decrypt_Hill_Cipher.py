...
# Folow this link https://en.wikipedia.org/wiki/Hill_cipher to understand Hill Cipher
...
# Calculate co-dactors for the given Matrix
...
# Calculate Dterminant of the Matrix Using CoFactors Given Earlier
...
'''
  INPUT : 
  e <string>
  Here e implies encrypt this string
  d <string>
  Here d implies decrypt the String
'''
while t > 0:
    line = input()
    if line[0] == 'e':
