...
def on_chat_message(msg):
    ...
    if command == 'c':
        ...
        markup = InlineKeyboardMarkup(inline_keyboard=[
                     ...
                     [InlineKeyboardButton(text='Download- aria2c -x 16 -s 16', callback_data='aria2c')],
        ...
        markup = ForceReply()
        bot.sendMessage(chat_id, 'Download Link Please', reply_markup=markup)
...
def on_callback_query(msg):
    ...
    if data == 'notification':
        ...
        if message_with_inline_keyboard:
            ...
            bot.editMessageText(msg_idf, 'Enter your download link!!!!!')
        else:
